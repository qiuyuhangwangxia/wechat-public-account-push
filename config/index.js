export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxf8d87305dddbe6a2",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c27f6bf01595e38074963d51557f8b13",
  ...
  USERS: [
    {
      ...
      id: "o84u46KxNCvM4W_-N99q6_fo2Ad4",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "HaWTHmhKUDhHP9eeTvux5D7W4UKyZ_hEs2XKLjFOCkk",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "青岛",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2019-10-29"},
      ]
    },
    {
      name: "老婆1",
